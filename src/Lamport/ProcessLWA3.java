...
public class ProcessLWA3 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        processLWA = new DatagramSocket(Message.LWA3_PORT);
        Message mssg;
        int timeStamp = 0;
        ...
        Lamport lamport = new Lamport(Message.LWA3, Message.MAX_CONNECTIONS ) {
            @Override
        ...
        while (true) {
            ...
            mssg = new Message(Message.TO_SCREEN, "Sóc el procés LWA3", Message.LWA3);
            for (int i = 0; i < 10; i++) {
            ...
            mssg = new Message(Message.FINISHED, timeStamp, Message.LWA3);
            Message.sendMessage(processLWA, mssg, Message.A_PORT);
